...
export default function UserCard({ user }: { user: User; }) {
  ...
  return (
    <Card bg={"dark"} onClick={openUserModal} radius={10} p={10} mah={250} pos={"relative"} style={{ cursor: "pointer" }}>
      <Grid>
        <Grid.Col span={3}>
          <Indicator position="top-start" color={user.is_online ? "lime" : "gray"} size={15} zIndex={0}>
